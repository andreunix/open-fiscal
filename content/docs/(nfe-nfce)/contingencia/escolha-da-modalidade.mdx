...
> 🔄 O valor `tpEmis=3` **não é contingência**: era o antigo SCAN (desativado pela NT 2015/002) e foi reaproveitado pela **NT 2021.002** para o regime especial **Nota Fiscal Fácil (NFF)**. Por isso a regra `B22-30` ainda rejeita (570) `tpEmis=3` quando interpretado como SCAN/SVC. Ver [Séries e numeração](/docs/fundamentos/series-e-numeracao).
...
| Campo | Valor |
|---|---|
| Documento | MOC 7.0 — Anexo III, §2.1, p. 5–16; Anexo IV e Especificações da Contingência Off-line v2.0. |
| Versão | v2.0 |
| Data | ver fonte original |
| Páginas/capítulo | §2; p. 5–16 |
