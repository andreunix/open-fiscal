...
> **Implementação:** instale a cadeia ICP-Brasil (Raiz Brasileira v10 + AC SERPRO) na truststore do cliente dos Web Services — não dependa só das âncoras públicas do sistema operacional, que podem não incluir a raiz ICP-Brasil. As cadeias mudam quando os certificados são renovados; trate-as como artefato versionado e revalide periodicamente. Arquivos de referência: `cadeia_www1.nfe.fazenda.gov.br.p7b` (Web Services) e `cadeia_www.nfe.fazenda.gov.br.p7b` (portal).
