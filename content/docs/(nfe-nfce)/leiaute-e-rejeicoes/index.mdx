...
> 🧪 **Casos completos.** Para ver os grupos montados por cenário (normal, devolução, exportação, combustível, contingência, eventos), com campos críticos e rejeições comuns, use [Exemplos e casos de teste](/docs/exemplos).
