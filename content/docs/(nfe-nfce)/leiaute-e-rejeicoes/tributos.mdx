...
> 🧭 Trilha navegável por tributo: [IBS](/docs/reforma-tributaria/ibs) · [CBS](/docs/reforma-tributaria/cbs) · [Imposto Seletivo](/docs/reforma-tributaria/imposto-seletivo) — parte da seção [Reforma Tributária](/docs/reforma-tributaria).
...
O `cCredPres` classifica o crédito presumido de IBS/CBS por fundamento legal ([LC 214/2025](/docs/legislacao/lc-214-2025-rtc)). A tabela vigente traz indicadores que definem **se** e **como** o crédito é apropriado — não basta o código existir:
