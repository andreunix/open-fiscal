...
Primeiro o autorizador valida o certificado usado na assinatura. Depois verifica estrutura da XMLDSig, digest, `SignatureValue` e vínculo permitido entre certificado e emitente. Detalhe de cada etapa e diagnóstico de `cStat` em [Segurança e assinatura](/docs/seguranca/erros-comuns).
